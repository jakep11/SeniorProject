...
// for the purpose of timing out sessions that have been unused for too long.
...
// Export a function that logs in |user| by creating an authToken and 
// sending it back as a cookie, creating a Session for |user|, and saving 
// it in |sessions| indexed// by the authToken.
//
// 1 Cookie is tagged by |cookieName|, times out on the client side 
// after |duration| (though the router, below, will check anyway to 
// prevent hacking), and will not be shown by the browser to the user, 
// again to prevent hacking.
